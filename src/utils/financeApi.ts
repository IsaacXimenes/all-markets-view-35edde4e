...
let despesas: Despesa[] = [
  ...
  },
  {
    ...
    tipo: 'Fixa',
    data: '2025-02-01',
    descricao: 'Energia Elétrica - Shopping Sul',
    valor: 1890.00,
    competencia: 'FEV-2025',
    conta: 'Santander (Unicred)',
    lojaId: LOJAS_FINANCE.SHOPPING_SUL,
  ...
  },
  {
    ...
    competencia: 'FEV-2025',
    conta: 'Santander (Unicred)',
    observacoes: 'Campanha Dia dos Namorados antecipada',
    lojaId: LOJAS_FINANCE.ONLINE,
    status: 'Agendado',
    categoria: 'Marketing',
