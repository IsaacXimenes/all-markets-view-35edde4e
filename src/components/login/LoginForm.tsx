  ...
  return (
    <div className={cn('w-full', className)} style={{ fontFamily: 'Inter, sans-serif' }}>
      ...
      <div className={isMobile ? "mb-5" : "mb-8"}>
        <h1 className={cn("font-black text-[#F7BB05] tracking-tighter uppercase mb-2", isMobile ? "text-2xl" : "text-4xl")} style={{ fontFamily: 'Inter, sans-serif' }}>Bem-vindo</h1>
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
        ...
        <div className="space-y-1.5">
          ...
          <div className="relative">
            ...
            <input
              ...
              className={cn(
                cn('w-full rounded-xl pl-11 pr-12 text-white text-sm', isMobile ? 'py-3' : 'py-3.5'),
                'border border-white/10 outline-none transition-all duration-300',
                'focus:border-[#F7BB05] focus:shadow-[0_0_0_3px_rgba(247,187,5,0.15)]',
        ...
        <div className="pt-2">
          <button
            ...
            disabled={isLoading}
            className={cn(
              cn('w-full rounded-xl font-bold text-base tracking-wide transition-all duration-300', isMobile ? 'py-3' : 'py-4'),
